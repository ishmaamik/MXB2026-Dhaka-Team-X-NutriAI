        ...
        <div className="relative">
          <div className="flex items-center justify-between p-4 border-b border-border">
            <div className="flex items-center gap-3 overflow-hidden">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#2D5A27] to-[#8FBC8F] flex items-center justify-center flex-shrink-0 shadow-sm">
            ...
            {!collapsed && (
              <button
                ...
                className="p-1.5 rounded-lg hover:bg-secondary text-foreground/70 hover:text-foreground transition-all duration-200 flex-shrink-0"
              >
          ...
          {collapsed && (
            <button
              ...
              className="absolute -right-3 top-6 w-6 h-6 rounded-full bg-card border border-border hover:bg-secondary text-foreground transition-all duration-200 flex items-center justify-center shadow-lg z-30"
            >
                ...
                <Link key={item.to} to={item.to} className="no-underline">
                  <button
                    className={`w-full flex items-center gap-3 h-11 rounded-lg transition-all duration-200 ${
                      ...
                      isActive
                        ? 'bg-gradient-to-r from-[#A67B5B] to-[#8B5A3C] text-white hover:opacity-90 shadow-sm'
        ...
        <div className="p-3 border-t border-border bg-secondary/30">
          <div className="flex flex-col gap-1">
            ...
            <Link to="/profile" className="no-underline">
              <button
                className={`w-full flex items-center gap-3 h-10 rounded-lg text-foreground/70 hover:bg-secondary hover:text-foreground transition-all duration-200 ${
                  collapsed ? 'px-0 justify-center' : 'px-3 justify-start'
                }`}
              >
